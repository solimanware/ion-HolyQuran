...
import { DbService, QuranService, HelperService } from '../shared/shared';
...
@NgModule({
  ...
  providers: [
    ...
    HelperService, DbService, QuranService, BookmarkService, SurahService, VerseService, JuzService
  ]
})
