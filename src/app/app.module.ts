...
import { DbService, QuranService, HelperService, EventPublisher } from '../shared/shared';
...
@NgModule({
  ...
  providers: [
    ...
    HelperService, DbService, QuranService, EventPublisher, BookmarkService, SurahService, VerseService, JuzService
  ]
})
